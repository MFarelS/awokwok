...
🌐️ *URL*: ${url}`
        ...
        case '❤️motivasi':
            ...
            break
	case '❤️howgay':
	    if (args.length === 1) return tobz.reply(from, `Untuk mengetahui seberapa gay seseorang gunakan ❤howgay namanya\n\nContoh: ❤howgay burhan`, id)
            ...
            break
        case '❤️cersex':
            const cersex = await get.get('https://rugaapi.herokuapp.com/api/cersex1')
            tobz.reply(from, `➸ *ini bozz* : ${cersex.result}\n➸ *Author* : ${cersex.author}`, id)
            break
        case '❤️katabijak':
